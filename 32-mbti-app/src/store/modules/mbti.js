    ...
    survey: [
        {
          ...
          {
            question: '새로운 서비스 개발 중에, 동료가 새로 나온 신기술을 쓰는게 더 편할거라고 추천을 해준다!\n\n나의 선택은!?',
            answer: [
              {
          ...
          {
            question: '서비스 출시 이틀 전 야근 시간, 갑자기 동료가 어!? 를 외쳤다!\n\n나의 선택은?',
            answer: [
              {
              ...
              {
                text: '아... 내일도 야근 각이구나 ᅲᅲ! 일단 동료의 자리로 가 본다',
                result: 'F',
              },
            ],
          },
          {
            question: '팀장님이 xx씨 그전에 말한 기능 내일 오후까지 완료 부탁해요라고 말했다!\n\n나의 선택은?',
            answer: [
              {
