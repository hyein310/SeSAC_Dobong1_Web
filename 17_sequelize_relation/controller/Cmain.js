...
exports.getTeams = async (req, res) => {
    try {
        ...
        if (sort === "name_asc") {
            ...
            // sort에 name_asc 외의 문자열이 들어오거나 sort_search 가 전달되지 않았을 때
            // Team 테이블의 team_id, name 컬럼 보여주기
...
exports.getTeamPlayers = async (req, res) => {
    try {
        // 1. 팀 정보는 안봐도 되고, 특정 팀의 선수 정보만 확인하기 위해서는 "Player 모델"에서 teamid 기준으로 조회
        const { teamId } = req.params;
