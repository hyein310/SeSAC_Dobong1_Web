...
/*
 * 메소드 오버로딩 ?
 * - 하나의 클래스에서 동일한 이름의 메서드를 여러 개의 정의할 수 있음
...
public class MethodOverloading {
    public static void main(String[] args) {
        ...
        System.out.println("실수 세 개 덧셈? " + ol.add(1.1, 2.2, 4.4)); // 기댓값 7.7 --> 결과값 7.700000000000001 (부동 소수의 한계)
