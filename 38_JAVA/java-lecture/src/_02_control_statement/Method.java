...
public class Method {
    public static void main(String[] args) {
        ...
        // 주소값 같은지 확인
        System.out.println(numbers); // 주소값 [I@312b1dae
        System.out.println(multi_10_2(numbers)); // 주소값 [I@312b1dae

        // 실행 후 결과 확인
        System.out.println("원래 numbers2 확인: " + Arrays.toString(numbers2));
        System.out.println("함수의 리턴 값 확인: " + Arrays.toString(multi_10_2(numbers2)));
